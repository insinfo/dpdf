...
void main() {
  group('CertificateSerial', () {
    ...
    test('equalsSerial compares decimal and hex forms robustly', () {
      ...
      expect(
          equalsSerial(
              '66104a9b', BigInt.parse('66104a9b', radix: 16).toString()),
          isTrue);
    ...
    test('invalid input throws', () {
      expect(() => CertificateSerial.fromHex('0x'),
          throwsA(isA<PdfFormatException>()));
      expect(() => CertificateSerial.fromHex('0xZZ'),
          throwsA(isA<PdfFormatException>()));
      expect(() => CertificateSerial.fromDecimal('-1'),
          throwsA(isA<PdfFormatException>()));
      expect(
          () => normalizeSerialToHex(''), throwsA(isA<PdfFormatException>()));
      expect(
