...
class AdobeGlyphList {
  static final _logger = LogManager.getLoggerByName('AdobeGlyphList');
  ...
  static void _ensureInitialized() {
    ...
    try {
      ...
      if (file.existsSync()) {
        ...
        _logger.logError("AdobeGlyphList.txt not found.");
      }
    } catch (e) {
      _logger.logError("AdobeGlyphList loading error: $e");
    } finally {
      _initialized = true;
    }
  }
