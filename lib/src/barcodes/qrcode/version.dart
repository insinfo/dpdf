...
class ECBlocks {
  ...
  int getNumBlocks() {
    int total = 0;
    for (int i = 0; i < _ecBlocks.length; i++) {
      total += _ecBlocks[i].getCount();
    }
    return total;
  }
...
class Version {
  ...
  static final List<Version> VERSIONS = _buildVersions();
  ...
  Version(
    ...
    List<ECB> ecbArray = ecBlocks1.getECBlocks();
  ...
  static Version? decodeVersionInformation(int versionBits) {
    int bestDifference = 0x7FFFFFFF; // int.max
    int bestVersion = 0;
  ...
  static List<Version> _buildVersions() {
    // This is a massive list initialization.
    // I will format it to be more Dart-like but keep content.
    return [
      Version(1, [], ECBlocks(7, ECB(1, 19)), ECBlocks(10, ECB(1, 16)),
          ECBlocks(13, ECB(1, 13)), ECBlocks(17, ECB(1, 9))),
      Version(2, [6, 18], ECBlocks(10, ECB(1, 34)), ECBlocks(16, ECB(1, 28)),
          ECBlocks(22, ECB(1, 22)), ECBlocks(28, ECB(1, 16))),
      Version(3, [6, 22], ECBlocks(15, ECB(1, 55)), ECBlocks(26, ECB(1, 44)),
          ECBlocks(18, ECB(2, 17)), ECBlocks(22, ECB(2, 13))),
      Version(4, [6, 26], ECBlocks(20, ECB(1, 80)), ECBlocks(18, ECB(2, 32)),
      ...
      Version(6, [6, 34], ECBlocks(18, ECB(2, 68)), ECBlocks(16, ECB(4, 27)),
