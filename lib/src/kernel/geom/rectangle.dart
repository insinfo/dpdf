...
class Rectangle {
  ...
  static Future<Rectangle?> fromPdfArray(PdfArray? array) async {
    ...
    final llx = (await array.numberEntry(0))?.doubleValue() ?? 0.0;
  ...
  void moveDown(double move) => y -= move;
  void moveUp(double move) => y += move;
  void moveRight(double move) => x += move;
  void moveLeft(double move) => x -= move;
}
