...
void main() {
  group('Vector', () {
    test('creates with coordinates', () {
      final v = CraftVector(1.0, 2.0, 3.0);
    ...
    test('get returns correct values', () {
      final v = CraftVector(1.0, 2.0, 3.0);
      expect(v.get(CraftVector.i1), equals(1.0));
      expect(v.get(CraftVector.i2), equals(2.0));
      expect(v.get(CraftVector.i3), equals(3.0));
    });

    test('subtract works correctly', () {
      final v1 = CraftVector(5.0, 7.0, 9.0);
      final v2 = CraftVector(1.0, 2.0, 3.0);
    ...
    test('add works correctly', () {
      final v1 = CraftVector(1.0, 2.0, 3.0);
      final v2 = CraftVector(4.0, 5.0, 6.0);
    ...
    test('multiply scales vector', () {
      final v = CraftVector(2.0, 3.0, 4.0);
    ...
    test('length calculates correctly', () {
      final v = CraftVector(3.0, 4.0, 0.0);
    ...
    test('equals compares correctly', () {
      final v1 = CraftVector(1.0, 2.0, 3.0);
      final v2 = CraftVector(1.0, 2.0, 3.0);
      final v3 = CraftVector(1.0, 2.0, 4.0);
      expect(v1 == v2, isTrue);
