...
class PdfName extends PdfPrimitiveObject {
  ...
  static final PdfName type3 = PdfName.intern('Type3');
  static final PdfName mMType1 = PdfName.intern('MMType1');
  ...
  static final PdfName charProcs = PdfName.intern('CharProcs');
  static final PdfName fontMatrix = PdfName.intern('FontMatrix');
  ...
  static final PdfName xrefStm = PdfName.intern('XRefStm');
  ...
  static final PdfName shadingType = PdfName.intern('ShadingType');
  static final PdfName function = PdfName.intern('Function');
  static final PdfName coords = PdfName.intern('Coords');
  ...
  static final PdfName identityH = PdfName.intern('Identity-H');
  static final PdfName identityV = PdfName.intern('Identity-V');
  static final PdfName toUnicode = PdfName.intern('ToUnicode');
  static final PdfName cidSystemInfo = PdfName.intern('CIDSystemInfo');
  static final PdfName cidToGIDMap = PdfName.intern('CIDToGIDMap');
  static final PdfName dw = PdfName.intern('DW');
  ...
  static final PdfName tabs = PdfName.intern('Tabs');
  ...
  static final PdfName opts = PdfName.intern('Opts');
  ...
  static final PdfName structTreeRoot = PdfName.intern('StructTreeRoot');
  static final PdfName thread = PdfName.intern('Thread');
  static final PdfName importData = PdfName.intern('ImportData');
  ...
  static final PdfName submitForm = PdfName.intern('SubmitForm');
  static final PdfName resetForm = PdfName.intern('ResetForm');

  // Tagged PDF / Structure
  static final PdfName roleMap = PdfName.intern('RoleMap');
  static final PdfName k = PdfName.intern('K');
  // PdfName.p is already defined
  static final PdfName parentTree = PdfName.intern('ParentTree');
  static final PdfName parentTreeNextKey = PdfName.intern('ParentTreeNextKey');
  static final PdfName classMap = PdfName.intern('ClassMap');
  static final PdfName structElem = PdfName.intern('StructElem');
  static final PdfName structParent = PdfName.intern('StructParent');
  static final PdfName structParents = PdfName.intern('StructParents');
  static final PdfName idTree = PdfName.intern('IDTree');
  static final PdfName namespace = PdfName.intern('Namespace');
  static final PdfName ns = PdfName.intern('NS');
  static final PdfName schema = PdfName.intern('Schema');
  static final PdfName roleMapNS = PdfName.intern('RoleMapNS');
  static final PdfName namespaces = PdfName.intern('Namespaces');

  // Additional Names for Catalog/Document
  static final PdfName names = PdfName.intern('Names');
  static final PdfName dests = PdfName.intern('Dests');
  static final PdfName outlines = PdfName.intern('Outlines');
  static final PdfName embeddedFiles = PdfName.intern('EmbeddedFiles');
  static final PdfName af = PdfName.intern('AF');
  static final PdfName afRelationship = PdfName.intern('AFRelationship');
  static final PdfName collection = PdfName.intern('Collection');
  static final PdfName outputIntents = PdfName.intern('OutputIntents');
  static final PdfName markInfo = PdfName.intern('MarkInfo');
  ...
  static final PdfName pageLabels = PdfName.intern('PageLabels');
  static final PdfName pieceInfo = PdfName.intern('PieceInfo');
  static final PdfName version = PdfName.intern('Version');
  static final PdfName start =
      PdfName.intern('Start'); // St is 2 chars usually but let's check standard
  static final PdfName st = PdfName.intern('St'); // For PageLabels

  // Destinations
  static final PdfName fit = PdfName.intern('Fit');
  static final PdfName xyz = PdfName.intern('XYZ');
  static final PdfName fitH = PdfName.intern('FitH');
  static final PdfName fitV = PdfName.intern('FitV');
  static final PdfName fitR = PdfName.intern('FitR');
  static final PdfName fitB = PdfName.intern('FitB');
  static final PdfName fitBH = PdfName.intern('FitBH');
  static final PdfName fitBV = PdfName.intern('FitBV');
  ...
  static final PdfName nums = PdfName.intern('Nums'); // Added
  static final PdfName outputIntent = PdfName.intern('OutputIntent');
  static final PdfName gts_pdfa1 = PdfName.intern('GTS_PDFA1');
  static final PdfName outputCondition = PdfName.intern('OutputCondition');
  static final PdfName outputConditionIdentifier = PdfName.intern('OutputConditionIdentifier');
  static final PdfName registryName = PdfName.intern('RegistryName');
  static final PdfName destOutputProfile = PdfName.intern('DestOutputProfile');

  // Font related (non-duplicates)
  static final PdfName baseEncoding = PdfName.intern('BaseEncoding');
  static final PdfName differences = PdfName.intern('Differences');
  static final PdfName winAnsiEncoding = PdfName.intern('WinAnsiEncoding');
  static final PdfName macRomanEncoding = PdfName.intern('MacRomanEncoding');
  static final PdfName macExpertEncoding = PdfName.intern('MacExpertEncoding');
  static final PdfName pdfDocEncoding = PdfName.intern('PdfDocEncoding');
  static final PdfName standardEncoding = PdfName.intern('StandardEncoding');
}
