...
/// standard 14 faces through [HtmlStandardFont], and this measure asks
...
abstract final class HtmlTextMeasure {
  ...
  static int charactersPerLine(HtmlTextStyle style, double width) {
  ...
  static double _averageAdvance(HtmlTextStyle style) {
    final font = HtmlStandardFont.resolve(style);
