...
class TiffConstants {
  ...
  /// CCITT Group 3 fax encoding (1D)
  static const int compressionCcittrlew = 32771;
  ...
  static const int tifftagJpegifoffset = 513;

  /// JPEG Interchange Format Byte Count
  static const int tifftagJpegifbytecount = 514;
