...
/// Collection operations shared by the PDF implementation.
class CollectionUtils {
  ...
  /// Creates a mutable set initially containing [o].
  static Set<T> singleton<T>(T o) => {o};

  /// Creates a growable list initially containing [o].
  static List<T> singletonList<T>(T o) => [o];

  /// Creates a mutable map initially containing [key] and [value].
  ...
  /// Overwrites the beginning of [dest] with as many elements of [src] as fit.
