...
abstract class SigningPrivateKey {
...
abstract class SigningPublicKey {
...
abstract class SignatureEngine {
  /// Initializes the signer for signing with a private key.
  void initSign(SigningPrivateKey privateKey);

  /// Initializes the signer for verification with a public key.
  void initVerify(SigningPublicKey publicKey);
