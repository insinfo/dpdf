...
class TextRenderer extends AbstractRenderer {
  ...
  LayoutResult? layout(LayoutContext layoutContext) {
    ...
    // print("TextRenderer layout: text='$text', maxWidth=$maxWidth, fontSize=$fontSize");
  ...
  Future<void> draw(DrawContext drawContext) async {
    ...
    // Use the GlyphLine if available to ensure correct glyph positioning (advances, offsets)
    canvas.moveText(x, y).showText(line ?? text).endText();
  }
}
