...
class HtmlListContext {
  ...
  HtmlListContext._(this.ordered, this.reversed, this._next);

  factory HtmlListContext.fromElement(dom.Element list) {
    final tag = list.localName?.toLowerCase();
    final ordered = tag == 'ol';
    if (!ordered) return HtmlListContext._(false, false, 0);
    ...
    return HtmlListContext._(true, reversed, start);
  }
