...
void main() {
  group('PdfDate', () {
    ...
    test('decode parses date without timezone', () {
      final d = CraftPdfDate.decode('D:20240601120000');
      expect(d.year, equals(2024));
    ...
    test('decode parses minimal date', () {
      final d = CraftPdfDate.decode('D:2024');
      expect(d.year, equals(2024));
